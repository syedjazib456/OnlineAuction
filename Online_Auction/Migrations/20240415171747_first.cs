        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CatImg = table.Column<string>(type: "varchar(max)", nullable: false),
                    CatDescription = table.Column<string>(type: "varchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    RatingsId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    UserRating = table.Column<decimal>(type: "decimal(2,1)", nullable: false),
                    ShipRating = table.Column<decimal>(type: "decimal(2,1)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReportMessage = table.Column<string>(type: "varchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reports_AspNetUsers_FromUserId",
                        column: x => x.FromUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Reports_AspNetUsers_ToUserId",
                        column: x => x.ToUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ProductId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ProductTitle = table.Column<string>(type: "varchar(100)", nullable: false),
                    ...
                    ProductImage1 = table.Column<string>(type: "varchar(max)", nullable: false),
                    ProductImage2 = table.Column<string>(type: "varchar(max)", nullable: false),
                    MinBidPrice = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
                    AuctionStartDate = table.Column<DateTime>(type: "date", nullable: false),
                    AuctionEndDate = table.Column<DateTime>(type: "date", nullable: false),
                    ProductStatus = table.Column<string>(type: "varchar(10)", nullable: false),
